...
## server
- 로컬 테스트 이후 aws ec2 프리티어 배포

Authentication & Security (정리용)

본 프로젝트는 외부 인증 및 SNS 로그인 연동을 전제로 설계된 구조이며,
...
단순 CRUD 앱이 아닌,
실제 서비스에 가까운 인증·지도·연동 구조 및 배포 위한 프로젝트입니다.

 Note

현재 기능 리빌딩 및 구조 정리 단계,
인증 및 외부 API 연동을 중심으로 점진적 확장을 진행
